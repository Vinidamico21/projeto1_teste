using IwantApp.Controllers.Endpoint.Categories;
using IwantApp.Controllers.Endpoint.Clients;
using IwantApp.Controllers.Endpoint.Products;
...
app.MapMethods(CategoriesGetAll.Template, CategoriesGetAll.Methods, CategoriesGetAll.Handle);
